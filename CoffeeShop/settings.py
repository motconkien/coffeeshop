...
#for deploy
ALLOWED_HOSTS = ['coffeeshop-knmn.onrender.com', 'www.coffeeshop-knmn.onrender.com']
...
SECRET_KEY = 'django-insecure-^(5*f8sm4qi=amfieg^gnnisyfe69b@f*@dhbr8fy2jo5_vj2v'
...
EMAIL_HOST_PASSWORD = 'your pass'  # Your email password or app-specific password register in gmail 
